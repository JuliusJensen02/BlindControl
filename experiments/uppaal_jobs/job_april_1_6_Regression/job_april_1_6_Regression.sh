#!/bin/bash
#SBATCH --job-name=1/april_6_+Regression
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_april_1_6_Regression || exit 1
...
' "$escaped_data_content" > data_content_2025-04-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=2 --exploration=1 | tee "output_april_1_6_${i}.csv"
done