#!/bin/bash
#SBATCH --job-name=4/february_3_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_february_4_3_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-02-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_february_4_3_${i}.csv"
done