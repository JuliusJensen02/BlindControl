#!/bin/bash
#SBATCH --job-name=12/january_5_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_january_12_5_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-01-17.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_january_12_5_${i}.csv"
done