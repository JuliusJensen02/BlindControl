#!/bin/bash
#SBATCH --job-name=4/january_7_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_january_4_7_Naive || exit 1
...
' "$escaped_data_content" > data_content_2025-01-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_january_4_7_${i}.csv"
done