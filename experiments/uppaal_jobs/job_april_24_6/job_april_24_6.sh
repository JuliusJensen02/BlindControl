...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_april_24_6 || exit 1
...
' "$escaped_data_content" > data_content_2025-04-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_april_24_6_${i}.csv"
done