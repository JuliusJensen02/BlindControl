#!/bin/bash
#SBATCH --job-name=4/winter_2_+Co-variance
...
' "$escaped_data_content" > data_content_2025-02-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=0 --exploration=1 | tee "output_winter_4_2_${i}.csv"
done