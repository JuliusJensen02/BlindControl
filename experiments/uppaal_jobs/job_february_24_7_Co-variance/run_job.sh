#!/bin/bash
#SBATCH --job-name=24/february_7_Co-variance
...
for ((i=0; i<=46; i++)); do
    ...
    sed -i "s|__PERIOD__|24|g" "uppaal.q"
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=2 --learning-method=0 -u | tee "output_${i}.csv"
