#!/bin/bash
#SBATCH --job-name=12/december_6_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_12_6_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2024-12-21.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_december_12_6_${i}.csv"
done