...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_24_5 || exit 1
...
' "$escaped_data_content" > data_content_2025-03-21.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_march_24_5_${i}.csv"
done