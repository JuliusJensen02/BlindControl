...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_april_24_3 || exit 1
...
' "$escaped_data_content" > data_content_2025-04-16.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_april_24_3_${i}.csv"
done