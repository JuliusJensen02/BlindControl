...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_1_3 || exit 1
...
' "$escaped_data_content" > data_content_2024-12-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_december_1_3_${i}.csv"
done