...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_4_4 || exit 1
...
' "$escaped_data_content" > data_content_2025-03-20.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_march_4_4_${i}.csv"
done