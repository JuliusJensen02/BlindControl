#!/bin/bash
#SBATCH --job-name=12/january_6_+Regression
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_january_12_6_Regression || exit 1
...
' "$escaped_data_content" > data_content_2025-01-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=2 --exploration=1 | tee "output_january_12_6_${i}.csv"
done