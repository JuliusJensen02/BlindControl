#!/bin/bash
#SBATCH --job-name=24/winter_3_+Regression
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_winter_24_3_Regression || exit 1
...
' "$escaped_data_content" > data_content_2025-02-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=2 --exploration=1 | tee "output_winter_24_3_${i}.csv"
done