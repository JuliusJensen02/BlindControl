...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_24_1 || exit 1
...
' "$escaped_data_content" > data_content_2024-12-16.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_december_24_1_${i}.csv"
done