...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_12_7 || exit 1
...
' "$escaped_data_content" > data_content_2025-03-23.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_march_12_7_${i}.csv"
done