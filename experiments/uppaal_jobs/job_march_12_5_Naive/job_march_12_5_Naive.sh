#!/bin/bash
#SBATCH --job-name=12/march_5_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_12_5_Naive || exit 1
...
' "$escaped_data_content" > data_content_2025-03-21.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_march_12_5_${i}.csv"
done