#!/bin/bash
#SBATCH --job-name=1/spring_4_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_1_4_Naive || exit 1
...
' "$escaped_data_content" > data_content_2025-04-17.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_spring_1_4_${i}.csv"
done