...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_february_1_2 || exit 1
...
' "$escaped_data_content" > data_content_2025-02-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_february_1_2_${i}.csv"
done