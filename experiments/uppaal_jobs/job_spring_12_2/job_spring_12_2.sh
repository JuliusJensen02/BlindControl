...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_12_2 || exit 1
...
' "$escaped_data_content" > data_content_2025-04-15.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_spring_12_2_${i}.csv"
done