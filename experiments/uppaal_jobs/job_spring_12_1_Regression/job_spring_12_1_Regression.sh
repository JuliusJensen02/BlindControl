#!/bin/bash
#SBATCH --job-name=12/spring_1_+Regression
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_12_1_Regression || exit 1
...
' "$escaped_data_content" > data_content_2025-04-14.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=2 --exploration=1 | tee "output_spring_12_1_${i}.csv"
done