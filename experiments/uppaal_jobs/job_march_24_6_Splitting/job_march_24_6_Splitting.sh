#!/bin/bash
#SBATCH --job-name=24/march_6_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_24_6_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-03-22.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_march_24_6_${i}.csv"
done