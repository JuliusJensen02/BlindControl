#!/bin/bash
#SBATCH --job-name=24/december_2_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_24_2_Naive || exit 1
...
' "$escaped_data_content" > data_content_2024-12-17.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_december_24_2_${i}.csv"
done