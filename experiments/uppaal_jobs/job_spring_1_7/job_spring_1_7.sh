...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_1_7 || exit 1
...
' "$escaped_data_content" > data_content_2025-04-20.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_spring_1_7_${i}.csv"
done