#!/bin/bash
#SBATCH --job-name=4/february_5_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_february_4_5_Naive || exit 1
...
' "$escaped_data_content" > data_content_2025-02-21.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_february_4_5_${i}.csv"
done