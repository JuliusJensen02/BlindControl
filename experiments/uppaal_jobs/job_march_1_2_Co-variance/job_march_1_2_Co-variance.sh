#!/bin/bash
#SBATCH --job-name=1/march_2_+Co-variance
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_1_2_Co-variance || exit 1
...
' "$escaped_data_content" > data_content_2025-03-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=0 --exploration=1 | tee "output_march_1_2_${i}.csv"
done