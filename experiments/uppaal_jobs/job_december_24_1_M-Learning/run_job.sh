#!/bin/bash
#SBATCH --job-name=24/december_1_M-Learning
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_24_1_M-Learning || exit 1
...
for ((i=0; i<=46; i++)); do
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=2 --learning-method=5 -u | tee "output_${i}.csv"
