...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_winter_12_6 || exit 1
...
' "$escaped_data_content" > data_content_2025-02-22.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_winter_12_6_${i}.csv"
done