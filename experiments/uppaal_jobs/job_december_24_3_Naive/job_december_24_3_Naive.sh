#!/bin/bash
#SBATCH --job-name=24/december_3_+Naive
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_december_24_3_Naive || exit 1
...
' "$escaped_data_content" > data_content_2024-12-18.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=3 --exploration=1 | tee "output_december_24_3_${i}.csv"
done