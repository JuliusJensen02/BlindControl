#!/bin/bash
#SBATCH --job-name=4/spring_6_+Regression
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_4_6_Regression || exit 1
...
' "$escaped_data_content" > data_content_2025-04-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=2 --exploration=1 | tee "output_spring_4_6_${i}.csv"
done