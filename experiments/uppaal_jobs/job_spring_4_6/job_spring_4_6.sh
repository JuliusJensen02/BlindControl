...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_4_6 || exit 1
...
' "$escaped_data_content" > data_content_2025-04-19.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_spring_4_6_${i}.csv"
done