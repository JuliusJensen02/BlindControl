#!/bin/bash
#SBATCH --job-name=12/february_7_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_february_12_7_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-02-23.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_february_12_7_${i}.csv"
done