...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_january_1_5 || exit 1
...
' "$escaped_data_content" > data_content_2025-01-17.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" | tee "output_january_1_5_${i}.csv"
done