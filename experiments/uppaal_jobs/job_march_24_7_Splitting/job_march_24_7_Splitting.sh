#!/bin/bash
#SBATCH --job-name=24/march_7_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_march_24_7_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-03-23.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_march_24_7_${i}.csv"
done