#!/bin/bash
#SBATCH --job-name=24/spring_2_+Splitting
...
cd /nfs/home/student.aau.dk/tb30jn/BlindControl/experiments/uppaal_jobs/job_spring_24_2_Splitting || exit 1
...
' "$escaped_data_content" > data_content_2025-04-15.txt
    ...
    verifyta "BlindModel.xml" "uppaal.q" --generate-strategy=1 --learning-method=1 --exploration=1 | tee "output_spring_24_2_${i}.csv"
done